...
function startOnboarding() {
  ob = { step: 1, name: '', goal: null, raceDate: null, fitnessMode: 'race', raceDist: '5k', raceH: 0, raceM: 25, raceS: 0, easyMin: 10, easySec: 0, weeklyMiles: 0, daysPerWeek: 4, longDay: 6, units: 'mi', experience: null, age: 0, injuryNotes: '', chat: [], typing: false, chatStep: 'hero' };
  renderOnboarding();
}
...
function obSendName() {
  ...
  let n = t.split(/\s+/)[0];
  ob.name = n.charAt(0).toUpperCase() + n.slice(1);
  userSay(esc(t));
...
function obExp(k) {
  ...
  userSay(labels[k]);
  coachSay(`Last thing - anything I should know? Your age, old injuries, tight spots. Type it out, or tap Skip.`, () => { ob.chatStep = 'extras'; renderChat(); });
}
